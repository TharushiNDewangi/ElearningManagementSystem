...
const StudentinInstitute = (props) => {
    ...
    useEffect(() => {
        function getStudentinInstitute() {
            axios
                .get('http://localhost:8065/api/studentInstitute/viewall')
                .then((res) => {
                    console.log(res.data.data);
                    console.log('res.data');
                ...
                <Row>
                    <Col>
                        ...
                        <Table style={{ fontsize: 12 }} responsive="sm">
                            ...
                            <tbody>
                                {studentsininstitute.map((studentsininstitute, index) => (
                                    <tr>
                                        <td
                                            onClick={() => showStudentDetailModal(studentsininstitute)}
                                            key={studentsininstitute._id}
                                        >
                                            {studentsininstitute.name}
                                        </td>
